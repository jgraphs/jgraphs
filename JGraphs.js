...
function textinput(e) {
    if(event.key === 'Enter') {
        ...
        if(text[0] == 'P') {
            ...
            cadena = cadena + "    Graph('E?oo', name = 'E?oo'),\n";
            cadena = cadena + "    Graph('ECQ_', name = 'ECQ_'),\n";
            cadena = cadena + "    Graph('EK]w', name = 'EK]w')]\n";
            cadena = cadena + "min_forbid7=[Graph('F?Cfw', name ='F?Cfw'),\n";
            cadena = cadena + "    Graph('F?D~o', name ='F?D~o'),\n";
            cadena = cadena + "    Graph('F?`@_', name = 'F?`@_'),\n";
            cadena = cadena + "    Graph('F?`Do', name = 'F?`Do'),\n";
            cadena = cadena + "    Graph('F?`bg', name = 'F?`bg'),\n";
            cadena = cadena + "    Graph('F?D~w', name ='F?D~w')]\n";
            cadena = cadena + "min_forbid8=[Graph('G?`@?_', name = 'G?`@?_')]\n";
            cadena = cadena + "\n";
